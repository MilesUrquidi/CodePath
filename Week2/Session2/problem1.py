...
Each dictionary represents data associated with a species, including its name, habitat, and wild population. The function should return the name of the species with the lowest population.
...
def most_endangered(species_list):
    ...
    for i in species_list:
        if i["population"] < mini["population"]:
            mini = i
    return mini["name"]
